...
<script>
    ...
    // Función para validar una fecha en el formato YYYY-MM-DD
    ...
    function generarCurp() {
        ...
        if (!validarTexto(apellidoPaterno)) {
        ...
        if (!validarTexto(apellidoMaterno)) {
        ...
        if (verificarCodigo()) {
            ...
            var curp = generaCurp({
                ...
                fecha_nacimiento: fechaNacimiento.split('-').reverse().map(
                    Number) // Convierte la fecha en un array [día, mes, año]
            });
